...
O aplicativo escolhido pelo grupo, e os motivos pela escolha, se apresentam na conclusão do artefato de [Aplicativos Analisados](https://requisitos-de-software.github.io/2022.2-Grasshopper/planejamento/aplicativos-analisados/).

## Planejamento de Entregas de Artefatos
O cronograma Planejado X Executado do projeto, se apresenta dentro do artefato de [Cronograma](https://requisitos-de-software.github.io/2022.2-Grasshopper/planejamento/cronograma/).

## Ferramentas 
As ferramentas utilizadas dentro do projeto, estão especificadas dentro do artefato de [Ferramentas](https://requisitos-de-software.github.io/2022.2-Grasshopper/planejamento/ferramentas/).

## Tabela de artefatos, autores, técnicas

Todas as fases, etapas, e artefatos construídos e executados dentro do projeto estão listados na <i>Tabela 1</i> com seus respectivos autores, revisores, ferramentas e técnicas utilizadas.
...
| Planejamento | [Aplicativos Analisados](https://requisitos-de-software.github.io/2022.2-Grasshopper/planejamento/aplicativos-analisados/) | Rich Picture, Introspecção |  Caio Vitor, João Pedro Alves, Philipe de Sousa, Lucas Lopes, Hellen Fernanda, Wildemberg Sales | Wildemberg Sales, Philipe de Sousa | Visual Studio Code |
| Pré-Rastreabilidade |    [Rich Picture](https://requisitos-de-software.github.io/2022.2-Grasshopper/pre-traceability/richpicture/)  |  Rich Picture, Introspecção  | Hellen Fernanda,Caio Vitor, Lucas Lopes |Caio Vitor, Lucas Lopes,Hellen Fernanda,Wildemberg Sales | Excel, LucidChart, Visual Studio Code  |
| Elicitação |  [Perfil do Usuário](https://requisitos-de-software.github.io/2022.2-Grasshopper/elicitacao/perfil-do-usuario/)  |   Questionário   |      Philipe de Sousa  |         Wildemberg Sales          |  Google Forms, Visual Studio Code |
| Elicitação |   [Personas](https://requisitos-de-software.github.io/2022.2-Grasshopper/elicitacao/personas/)       |        personificação        |   Philipe de Souza,Wildemberg Sales,Lucas Lopes             |  Lucas Lopes,Wildemberg Sales             | This person does not exist, Visual Studio Code  | 
| Elicitação |   [Storytelling](https://requisitos-de-software.github.io/2022.2-Grasshopper/elicitacao/storytelling/)      |   Personificação, Encenação, Storytelling  |   Wildemberg Sales,Phelipe de Souza,Lucas Lopes,João Pedro             |   Caio Vitor,Wildemberg Sales            |  Teams, Visual Studio Code  |
| Elicitação |   [Brainstorm](https://requisitos-de-software.github.io/2022.2-Grasshopper/elicitacao/brainstorm/)  |  Brainstorm  | Caio,Vitor,Wildemberg Sales,Phelipe de Souza,Lucas Lopes,João Pedro,Hellen Fernanda   |     Philipe de Sousa,João Pedro   |  Teams,LucidChart, Visual Studio Code  |
|Elicitação |   [Observação](https://requisitos-de-software.github.io/2022.2-Grasshopper/elicitacao/observacao/)  |     Observação       |  Lucas Lopes, Philipe de Sousa  |     João Pedro          |  Visual Studio Code  |
|Elicitação |   [Priorização - In Or Out](https://requisitos-de-software.github.io/2022.2-Grasshopper/elicitacao/priorizacao/in-or-out/) |  Priorização in or Out, Encenação  |    Caio Vitor, João Pedro, Hellen Fernanda,Philipe de Sousa   |   Wildemberg Sales     | Visual Studio Code |
|Elicitação |   [Priorização - Three Level-Scale](https://requisitos-de-software.github.io/2022.2-Grasshopper/elicitacao/priorizacao/threeLevel-Scale/)       |   Priorização Three Level-Scale, Encenação   |  Lucas Lopes, Wildemberg Sales, Philipe de Sousa    |       Hellen Fernanda  |LucidChart, Visual Studio Code |
|Modelagem |    [Cenários](https://requisitos-de-software.github.io/2022.2-Grasshopper/modelagem/cenarios/)        |        Cenários        | Lucas Lopes, Hellen Fernanda  |   Philipe de Sousa     | Visual Studio Code |
|Modelagem |    [Léxicos](https://requisitos-de-software.github.io/2022.2-Grasshopper/modelagem/lexicos/)   |   Léxicos   |      Wildemberg Sales, João Pedro          |      Lucas Lopes         |  Visual Studio Code  |
|Modelagem |    [Casos de Uso](https://requisitos-de-software.github.io/2022.2-Grasshopper/modelagem/casos-de-uso/)       |     Casos de Uso           |    Philipe de Sousa, Wildemberg Sales   |     Wildemberg Sales, Philipe de Sousa    | LucidChart, Visual Studio Code  |
|Modelagem |    [Especificação Suplementar](https://requisitos-de-software.github.io/2022.2-Grasshopper/modelagem/especificao-suplementar/)    |     Especificação Suplementar, FURPS+           |     Caio Vitor  |      Wildemberg Sales         | Visual Studio Code |
|Modelagem Ágil |    [Backlog](https://requisitos-de-software.github.io/2022.2-Grasshopper/modelagem/modelagemAgil/backlog/)        |   Histórias de Usuário, Épico, Feature   |    Wildemberg Sales, Hellen Fernandes            |   Caio Vitor            |  Visual Studio Code  |
|Modelagem Ágil |    [Histórias de Usuário](https://requisitos-de-software.github.io/2022.2-Grasshopper/modelagem/modelagemAgil/historias-de-usuario/)      |    Histórias de Usuário, Entrevista   |       Lucas Lopes, Caio Vitor         |    Hellen Fernanda           |  Teams, Visual Studio Code  |
...
|Análise de Requisitos - Teste Piloto - Lichess|     [First Things First](https://requisitos-de-software.github.io/2022.2-Grasshopper/analise-de-requisitos/verificacao/testePiloto-Lichess/Ftf-Lichess/)        |   Inspeção, Checklist             |  Philipe de Sousa |  Hellen Fernanda  |  Visual Studio Code   |
...
|Análise de Requisitos - Validação |      [Protipagem](https://requisitos-de-software.github.io/2022.2-Grasshopper/analise-de-requisitos/validacao/prototipacao/)     |  Prototipação, Entrevista  |      Lucas Lopes, Hellen Fernanda, Wildemberg Sales          |    João Pedro |  Visual Studio Code, Figma  |
